...
/* harmony import */ var _modules_more__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/more */ "./js/modules/more.js");
/* harmony import */ var _modules_more__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(_modules_more__WEBPACK_IMPORTED_MODULE_2__);
...
/* harmony import */ var _modules_form_checker__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/form-checker */ "./js/modules/form-checker.js");
/* harmony import */ var _modules_form_checker__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(_modules_form_checker__WEBPACK_IMPORTED_MODULE_4__);
/* harmony import */ var _modules_footer_list__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./modules/footer_list */ "./js/modules/footer_list.js");
/* harmony import */ var _modules_footer_list__WEBPACK_IMPORTED_MODULE_5___default = /*#__PURE__*/__webpack_require__.n(_modules_footer_list__WEBPACK_IMPORTED_MODULE_5__);
/* harmony import */ var _modules_webp_background__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./modules/webp-background */ "./js/modules/webp-background.js");
/* harmony import */ var _modules_webp_background__WEBPACK_IMPORTED_MODULE_6___default = /*#__PURE__*/__webpack_require__.n(_modules_webp_background__WEBPACK_IMPORTED_MODULE_6__);
...
var contacts = document.querySelector('.contacts__header');
var sections = document.querySelector('.sections__header');
var contactsList = document.querySelector('.contacts__list');
var sectionsList = document.querySelector('.sections__list');
var contactsAddress = document.querySelector('.contacts__address');
var contactsPlus = document.querySelector('.contacts__header-plus');
var sectionsPlus = document.querySelector('.sections__header-plus');
...
var openLists = function openLists() {
...
var openContacts = function openContacts() {
  closeLists();
  contactsList.classList.remove('visually-hidden');
  contactsAddress.classList.remove('visually-hidden');
  contactsPlus.classList.add('visually-hidden');
};
var openSections = function openSections() {
  closeLists();
  sectionsList.classList.remove('visually-hidden');
...
var more = document.querySelector('.button__text--shown');
var less = document.querySelector('.button__text--hidden');
var text = document.querySelector('.about__text--additional');
...
var button = document.querySelector('.main-block__button');
...
var setFormBlockBG = function setFormBlockBG() {
...
window.onload = function () {
  ...
  var firefoxVer = isitFirefox ? parseInt(isitFirefox[1], 10) : 0;
  if (canUseWebp() || firefoxVer >= 65) {
    var products = document.querySelectorAll('.product');
    for (var i = 0; i < products.length; i++) {
      var webp = products[i].getAttribute('data-bg-webp');
